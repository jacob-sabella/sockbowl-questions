 ...
 * Question generation relies on the LLM's own knowledge (no external tools).
 * Supports both Ollama (local) and OpenAI (API) as LLM providers.
 */
@Configuration
public class AiConfig {
    ...
    public ChatClient chatClient(ChatClient.Builder chatClientBuilder) {
        ...
        // Build and return the configured ChatClient (LLM knowledge only, no external tools)
